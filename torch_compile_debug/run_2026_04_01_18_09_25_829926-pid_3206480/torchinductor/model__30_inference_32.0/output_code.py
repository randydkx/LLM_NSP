...
# kernel path: /tmp/torchinductor_ma-user/st/csty2o2472tyykrv4imwci6sw67kwdjegld3634huvumxdx7egae.py
...
@npu_triton_heuristics.reduction_npu_index(
    ...
    inductor_meta={'grid_type': 'GridNpu', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__npu_dtype_cast__softmax_logsumexp_mul_npu_dtype_cast_sub_sum_0', 'mutated_arg_names': ['in_out_ptr1'], 'backend_hash': '979696580158830a583bc7fba81ff8ee2cc5867124830081a9241511c8991f6f', 'split_axis': [0], 'tiling_axis': [0, 1], 'axis_names': ['x0', 'r1'], 'low_dims': {0, 1}, 'numof_reduction_axis': 1, 'split_axis_dtype': torch.float32, 'dual_reduction': False, 'traced_graph_hash': 'TRACED_GRAPH_HASH', 'traced_graph_dir': 'TRACED_GRAPH_DIR', 'store_cubin': False, 'force_disable_caches': False, 'profile_bandwidth_with_do_bench_using_profiling': False}
)
@triton.jit
...
def call(args):
    ...
    triton_unk_fused__npu_dtype_cast__softmax_logsumexp_mul_npu_dtype_cast_sub_sum_0.run(buf5, arg2_1, s57, 16865, 152064, stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 16865
    arg1_1 = 152064
    arg2_1 = rand_strided((16865, 152064), (152064, 1), device='npu:0', dtype=torch.bfloat16)
