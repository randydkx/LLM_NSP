...
# kernel path: /tmp/torchinductor_ma-user/2z/c2zzkpil7be45ohab3staoyv3kdnfzaop7mdmx6dq2ymsymljcif.py
...
def call(args):
    ...
    triton_unk_fused__npu_dtype_cast__softmax_logsumexp_mul_npu_dtype_cast_sub_sum_0.run(buf5, arg2_1, s57, 16718, 152064, stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 16718
    arg1_1 = 152064
    arg2_1 = rand_strided((16718, 152064), (152064, 1), device='npu:0', dtype=torch.bfloat16)
