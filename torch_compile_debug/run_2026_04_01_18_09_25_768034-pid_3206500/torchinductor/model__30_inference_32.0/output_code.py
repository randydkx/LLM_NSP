...
# kernel path: /tmp/torchinductor_ma-user/mt/cmt7h2ghzkzgad6os36o46pq6dcq44bk67o366wfxrzih3tk4jso.py
...
def call(args):
    ...
    triton_unk_fused__npu_dtype_cast__softmax_logsumexp_mul_npu_dtype_cast_sub_sum_0.run(buf5, arg2_1, s57, 15206, 152064, stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 15206
    arg1_1 = 152064
    arg2_1 = rand_strided((15206, 152064), (152064, 1), device='npu:0', dtype=torch.bfloat16)
